    ...
    prompts: [
      {
        ...
        message:
          'What is the site URL of you website? (Ex. https://teammind.dev)',
        default: allVariables.NEXT_PUBLIC_SITE_URL,
      },
      {
        type: 'input',
        name: 'values.NEXT_PUBLIC_PRODUCT_NAME',
        message: 'What is the name of your product? (Ex. TeamMind)',
      ...
      },
      {
        ...
        message:
          'What is the title of your website? (Ex. TeamMind - The best way to make things)',
      ...
      },
      {
        ...
        message:
          'What is the description of your website? (Ex. TeamMind is the best way to make things and stuff)',
      ...
      },
      {
        ...
        message: 'What is the email sender? (ex. info@teammind.dev)',
      },
      {
        when: (answers) => answers.values.MAILER_PROVIDER === 'nodemailer',
        type: 'input',
