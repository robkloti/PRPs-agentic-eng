...
export const AcademicPapersToolUI = makeAssistantToolUI<AcademicSearchArgs, AcademicSearchResult>({
          ...
          <CardHeader className="pb-2 flex flex-row items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Searching for "{args.query}"...</p>
              </div>
            </div>
          </CardHeader>
          <div className="px-4 pb-4 animate-pulse">
            {[1, 2, 3].map((i) => (
              <div key={i} className="h-[100px] bg-neutral-100 dark:bg-neutral-800 rounded-lg mb-3" />
            ))}
          </div>
        </Card>
      );
