...
import {
    ...
    AccordionItem,
    AccordionTrigger,
} from "@tm/ui/accordion";
import { Badge } from "@tm/ui/badge";
import { Button } from "@tm/ui/button";
import { Dialog, DialogContent } from "@tm/ui/dialog";
import { Drawer, DrawerContent } from "@tm/ui/drawer";
...
export const MultiSearchToolUI = makeAssistantToolUI<MultiSearchArgs, MultiSearchResponse>({
    toolName: 'web_search',
    render: ({ args, status, result }) => {
        if (status.type === 'running' || !result) {
            return <SearchLoadingState queries={args.queries} annotations={args.annotations} />;
        }
