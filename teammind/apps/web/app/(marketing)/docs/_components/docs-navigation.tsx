...
import { Cms } from '@tm/cms';
import { isBrowser } from '@tm/shared/utils';
import { Button } from '@tm/ui/button';
import { If } from '@tm/ui/if';
import { cn, isRouteActive } from '@tm/ui/utils';
  ...
  return (
    <>
      <aside
        ...
        className="sticky top-2 mt-16 hidden w-80 shrink-0 overflow-y-auto border-r p-4 lg:flex"
      >
