...
import { Avatar, AvatarFallback, AvatarImage } from '@tm/ui/avatar';
...
import { Popover, PopoverContent, PopoverTrigger } from '@tm/ui/popover';
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            aria-expanded={open}
            className={cn(
              'dark:shadow-primary/10 group h-11 w-full min-w-0 px-3',
              {
