...
function PricingItem(
  ...
  return (
    <div className="group relative w-full">
      {highlighted && (
        <div className="animate-gradient-x from-brand-purple via-brand-blue to-brand-coral absolute -inset-0.5 rounded-lg bg-gradient-to-r opacity-70 blur-sm transition duration-1000 group-hover:opacity-100 group-hover:duration-200" />
      )}
      <div
        data-cy={'subscription-plan'}
        className={cn(
          props.className,
          `bg-background relative flex w-full flex-1 grow flex-col items-stretch justify-between self-stretch rounded-lg border-transparent p-8`,
          {
            ['shadow-lg']: highlighted,
            ['dark:shadow-primary/40 shadow dark:shadow-sm']: !highlighted,
          },
        )}
      >
